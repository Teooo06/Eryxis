...
CREATE TABLE `utente`(
    ...
    CONSTRAINT fk_utente_permesso FOREIGN KEY (`id_permesso`) REFERENCES `permesso`(`idPermesso`) ON DELETE CASCADE
...
CREATE TABLE `ticket`(
    ...
    CONSTRAINT fk_ticket_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `rubrica`(
    ...
    `id_utente` INT NOT NULL,
    CONSTRAINT fk_rubrica_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `log`(
    ...
    `id_utente` INT NOT NULL,
    CONSTRAINT fk_log_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `conto` (
    ...
    CONSTRAINT fk_conto_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE,
    CONSTRAINT fk_conto_consulente FOREIGN KEY (`id_consulente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `transazione`(
    ...
    CONSTRAINT fk_transazione_conto FOREIGN KEY (`IBAN`) REFERENCES `conto`(`IBAN`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `carta`(
    ...
    `circuito` VARCHAR(3),
    `IBAN` VARCHAR(27) NOT NULL,
    CONSTRAINT fk_carta_conto FOREIGN KEY (`IBAN`) REFERENCES `conto`(`IBAN`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `investimento`(
    ...
    `id_utente` INT NOT NULL,
    CONSTRAINT fk_investimento_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `finanziamento`(
    ...
    `id_utente` INT NOT NULL,
    CONSTRAINT fk_finanziamento_utente FOREIGN KEY (`id_utente`) REFERENCES `utente`(`idUtente`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;